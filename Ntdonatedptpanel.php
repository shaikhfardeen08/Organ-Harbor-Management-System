...
<body>
    ...
    <div class="content centered-panel">
        ...
        <!-- Not Donated Patients Panel -->
        <div class="panel">
            <h2>Not Donated Patients</h2>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                       <!-- Populate with patient details data -->
                        ...
                        <?php
                        include "DONATEDPTPNL.php";
                        $query = "SELECT * FROM notdonated_patient"; // Replace with your actual table name
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><span style='color: red;'>Organ not received</span></td>"; // Display in red color
                            echo "<td>";
                            echo "<button type='submit'  class='delete-button' name='delete' value='{$row['id']}'>Delete</button>"; // Add a delete button here
                            echo "</td>";
                            echo "</tr>";
                        }
                        ...
                        if (isset($_GET['delete'])) {
                            ...
                            $deleteQuery = "DELETE FROM notdonated_patient WHERE id = $deleteId";
                            if (mysqli_query($conn, $deleteQuery)) {
                                echo "<script>alert('Record deleted successfully');</script>";
                                header("Location: Ntdonatedptpanel.php"); // Redirect back to the same page to refresh the table
                                exit();
                            } else {
