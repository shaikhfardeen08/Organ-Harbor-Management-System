            ...
            <table class="table">
                ...
                <tbody>
                       <!-- Populate with patient details data -->
                        ...
                        $query = "SELECT * FROM donated_patients"; // Replace with your actual table name
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><span style='color: green;'>Organ received</span></td>"; // Display in green color
                            echo "<td>{$row['ReceivedTime']}</td>"; // Display received time
                            echo "<td>";
                            echo "<button type='submit'  class='delete-button' id='delete' name='delete' value='{$row['id']}'>Delete</button>"; // Add a delete button here
                            echo "</td>";
                            echo "</tr>";
                        }
                        ...
                        if (isset($_GET['delete'])) {
                            ...
                            if (mysqli_query($conn, $deleteQuery)) {
                                ...
                                header("Location: donatedptpanel.php"); // Redirect back to the same page to refresh the table
                                exit();
                            } else {
